                ...
                <div className="item-container" key={id}>
                 ...
                 <div className="item-title">
                  ...
                  <div className="extra-options">
                    <label>Qty: 
                    <select value={quantity} className="select-quantity">
                    ...
                    <button onClick={() => deleteItemCart(item)} className="extra-buttons">Delete</button>
                    <button className="extra-buttons">Save for later</button>
                    <button className="extra-buttons">See more like this</button>
